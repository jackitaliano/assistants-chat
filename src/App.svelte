<script>
  ...
  import { ASSISTANT_CONFIG, ASSISTANT_INITIAL_MESSAGES } from './assistant/assistant';
  import { funcCalling } from './assistant/assistantFunctions';
  ...
  async function initKeyAsstAndThreads() {
    ...
    activeInitialMessages = ASSISTANT_INITIAL_MESSAGES;
    activeAsstConfig = ASSISTANT_CONFIG;
